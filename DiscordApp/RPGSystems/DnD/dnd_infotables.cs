        ...
        public async Task additemsFromClass(string character, DnDInventory inventory, CommandContext ctx, DiscordChannel userChannel, EmojiBase emojis)
        {
            ...
            switch (character)
            {
                ...
                case "Bard":
                    ...
                    await inventory.AddArmor("leather armor", 1, userChannel);
                ...
                case "Cleric":
                    ...
                    {
                        await inventory.AddArmor("Scale mail", 1, userChannel);
                    }
                    ...
                    {
                        await inventory.AddArmor("Chainmail", 1, userChannel);
                    }
                    ...
                    if (clericweaponResult.Result.Emoji == emojis.one)
                    {
                        await inventory.AddWeapon("light crossbow", 1, userChannel);
